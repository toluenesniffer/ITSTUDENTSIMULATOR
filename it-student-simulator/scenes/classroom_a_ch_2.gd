...
func _on_ready() -> void:
	...
	if(Dialogic.VAR.cestina2Played == true and Dialogic.VAR.matika2Played == false):
		TaskUI.update_task("SNAŽ SE ZÍSKAT DOBROU ZNÁMKU")
		Dialogic.start("res://dialogicYap/Chapter 2/matika_druhak.dtl")
	else:
		pass
...
func _on_button_pressed() -> void:
	if Dialogic.VAR.matikaPlayed == true and Dialogic.VAR.hardwarePlayed == false:
		TaskUI.update_task("JDI DO TŘÍDY E")
